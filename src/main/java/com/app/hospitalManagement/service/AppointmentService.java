...
import com.app.hospitalManagement.entity.Appointment;
import com.app.hospitalManagement.entity.Doctor;
import com.app.hospitalManagement.entity.Patient;
import com.app.hospitalManagement.repository.AppointmentRepository;
import com.app.hospitalManagement.repository.DoctorRepository;
...
public class AppointmentService {
    ...
    public Appointment reAssignAppointmentToAnotherDoctor(Long appointmentId, Long doctorId){
        ...
        appointment.setDoctor(doctor); // this will automatically call the update, bcause it is dirty
